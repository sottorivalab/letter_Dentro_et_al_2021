...
The process is ideally:
  - Select out the SNPs for the particular patient (from the consensus file pcawg8.snps.indels.svs.phased.icgc.v2.controlled.vcf.gz )
  - Filter for diploid SNPs (using the consensus somatic CNA PCAWG file) using the script below
  - Make a pileup file based on the bam
